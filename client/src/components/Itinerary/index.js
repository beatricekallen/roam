  ...
  return (
    <div className="parent-container">
      ...
      >
        ...
        >
          <ToggleButton value="info" aria-label="info toggle" className="font">
            Info
          </ToggleButton>
          <ToggleButton value="edit" aria-label="edit toggle" className="font">
            Edit
          </ToggleButton>
        </ToggleButtonGroup>
      </div>
              ...
              >
                ...
                <CardContent>
                  <Typography gutterBottom variant="h5" component="div">
                    {trip.members ? "Members" : "No other attendees"}
                  </Typography>
